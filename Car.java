...
public class Car extends Thread {
  ...
  public void run () {
    for (int I=1;  I<= 4; I++) {
      ...
      try{Synch.mutex.acquire();} catch(Exception e){System.out.println(e);}
      TrafficLight.westbound.acquire();
      Synch.mutex.release();
      TrafficLight.westbound.release();// started crossing, give the next car permission to cross
      ...
      try{Synch.mutex.acquire();} catch(Exception e){System.out.println(e);}
      TrafficLight.eastbound.acquire();
      Synch.mutex.release();
      TrafficLight.eastbound.release();// started crossing, give the next car permission to cross
